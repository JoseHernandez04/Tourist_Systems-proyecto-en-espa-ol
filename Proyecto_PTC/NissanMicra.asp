...
<body>
    <header class="contener">
        ...
        <nav class="menu">
            ...
            <div class="social-icon">
                <a href="NissanMicra-ingles.asp" class="social-icon__link"><span class="icon-language"></span></a>
    ...
    <div class="container-content">
        <article>
            ...
            <h1>
                Características técnicas Nissan Micra 1.0 54 kW
            </h1>
            <h2>
                Motor Combustión
            </h2>
            <p>Posición del motor:Delantero transversal</p>
            <p>Tipo de combustible:Gasolina</p>
            <p>Posición motor:Delantero transversal</p>
            <p>Cilindrada (cc): 999 </p>
            <p>Número de cilindros: 3</p>
            <p>Válvulas por cilindro: 4</p>
            <p>Alimentación: Inyección Indirecta.</p>
            <p>Distribución: 4 valvulas por cilindro.Dos árboles de levas en la culata.</p>
            <p>Sistema Stop&Start: NO</p>
            <p>Par máximo: (Nm / rpm)95   </p>
            <p>Potencia máxima: Cv(kW) / rpm:70(52) / 6300</p>
            <p></p>

            <h2>
                Transmisión
            </h2>
            <p>Tipo de Tracción: Delantera</p>
            <p>Caja de cambio: Manual de 5 velocidades</p>
            <p>Desarrollos: (km/h a 1000 rpm)1: 7 / 2: 12.7 / 3: 18.7 / 4: 25.4 / 5: 31.8 / R: 7.4</p>
            ...
            <p>Ancho (mm): 1743</p>
            <p>Alto (mm): 1455</p>
            <p>Distancia entre ejes (mm): 2525</p>
            <p>Vía delantera y trasera (mm): 1510 - 1520Peso (kg)1052</p>
            <p>Capacidad maletero (litros): 300</p>
            <p>Depósito combustible (litros): 41</p>
            <p>Número de asientos: 5</p>

            <h2>
                Renndimiento
            </h2>
            <p>Consumo urbano (l/100 km): 5.9</p>
            <p>Consumo extraurbano (l/100 km): 3.8</p>
            <p>Consumo medio (l/100 km):4.6</p>
            <p>Emisiones de CO2 (gr/km): 103</p>
        ...
        <div class="container-aside">
            ...
            <aside>
                ...
                <a href="selecciondepago.aspx"><button>Rentar !Aqui¡</button></a>
            </aside>

            <aside>
                <img src="carros/11.jpg" alt="">
                <h2>Kia Stringer 2018</h2>
                <a href="KIA_Stinger.asp"><button>Rentar !Aqui¡</button></a>
            </aside>
