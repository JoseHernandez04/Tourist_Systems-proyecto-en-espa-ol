...
<body>
  ...
  <nav class="main-nav">
      <div class="container container--flex">
          ...
          <ul class="menu" id="menu">
              <li class="menu__item"><a href="index.aspx" class="menu__link" >Inicio</a></li>
              <li class="menu__item"><a href="Login.aspx" class="menu__link" >Login</a></li>
              <li class="menu__item"><a href="Registro.aspx" class="menu__link" >Registrarse</a></li>
          </ul>
          <div class="social-icon">
              <a href="Olvidoingles.asp" class="navbar-brand"><span class="icon-language"></span></a>
  ...
  <section class="banner">
      ...
      <div class="banner__content">Olvido su contraseña</div>
  </section>
    ...
    <section class="group main__about__descrition">
        <div class="container container--flex">
            ...
            <div class="column column--50">
                <h3 class="column__title">¿Olvido su contraseña?:</h3>
                <p class="column__txt">En caso de haber olvidado su contraseña debera registrarse nuevamente recordando que no puede volver a utilizar su nombre de usuario, debera crear un nuevo nombre de usuario </p>
                <a href="Registro.aspx" class="icon-cc-discover btn btn--contact" >Registrarse</a>
            </div>
        </div>
    </section>
