...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="ZapatosAdmin.aspx">Hoteles</a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link" href="ZapatosAdmin.aspx">Renta de autos</a>
                </li>
            </ul>
    ...
    <div class="container">
             <h2>Tourist Systems</h2>
       <asp:GridView ID="GridViewUsers" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="GridViewUsers_SelectedIndexChanged"> 
        <AlternatingRowStyle BackColor="White"/>
            <Columns>
                ...
                <asp:BoundField DataField="Imagenes" HeaderText="Imagenes" />
            </Columns>
