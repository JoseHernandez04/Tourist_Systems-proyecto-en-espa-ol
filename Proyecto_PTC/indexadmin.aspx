      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="indexadmin.aspx"> Panel de control </a></li>
            <li><a href="paginas.aspx">Paginas</a></li>
            <li><a href="alquileres.aspx">Alquileres</a></li>
        ...
        <div class="row">
          ...
          <div class="col-md-9">
            ...
            <div class="panel-body">
              ...
              <div class="col-md-3">
                <div class="well dash-box">
                  <h2><span class="glyphicon glyphicon-stats" aria-hidden="true"></span> 153</h2>
                  <h4> Visitantes</h4>
                </div>
              </div>
            </div>
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              <table class="table table-striped table-hover">
                ...
                <tr>
                  <td> Jose Alfredo</td>
                  <td> hjosealfredo@gmail.com</td>
                  <td> 10/9/2014</td>
                </tr>
                <tr>
                  <td> Emmanuel Posada</td>
                  <td> emmanuelp@gmail.com</td>
                  <td> 18/6/2019</td>
                </tr>
                <tr>
                  <td> Joshua Alexander</td>
                  <td> joshuaale@gmail.com</td>
                  <td> 1/2/2017</td>
                </tr>
                <tr>
                  <td> Diego Martinez</td>
                  <td> martinezdiego@gmail.com</td>
                  <td> 4/3/2018</td>
                </tr>
                <tr>
                  <td> Felix Masin</td>
                  <td> felixm@gmail.com</td>
                  <td> 25/5/2012</td>
                </tr>
              </table>
            </div>
