...
<body>
    ...
    <div class="container-content">
        <article>
            ...
            <h1>
                Características técnicas Mercedes-Benz Clase G 
            </h1>
            <h2>
                Motor Combustión
            </h2>
            <p>Posición del motor:Delantera </p>
            ...
            <p>Distribución: 4 valvulas por cilindro. Cuatro árboles de levas en la culata.</p>
            <p>Sistema Stop&Start: No</p>
            <p>Par máximo: 525 Nm  </p>
            <p>Potencia máxima: 433 CV / 350  kW
<p></p>

            <h2>
                Transmisión
            </h2>
            <p>Tipo de Tracción: 4x4</p>
            <p>Caja de cambio: Automatica </p>
            ...
            <p>Ancho (mm): 1.931  </p>
            <p>Alto (mm): 1.969  </p>
            <p>Distancia entre ejes (mm): 2520</p>
            <p>Vía delantera y trasera (mm): 1510 - 1,642 kg (kg)1,642</p>
            <p>Capacidad maletero (litros): 2.126</p>
            <p>Depósito combustible (litros): 100</p>
            <p>Número de asientos: 3</p>

            <h2>
                Renndimiento
            </h2>
            <p>Consumo urbano (l/100 km): 4.0</p>
