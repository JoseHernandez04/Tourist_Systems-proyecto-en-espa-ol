...
<body>
    <header class="contener">
        ...
        <nav class="menu">
            ...
            <div class="social-icon">
                <a href="ToyotaCamry_ingles.asp" class="social-icon__link"><span class="icon-language"></span></a>
    ...
    <div class="container-content">
        <article>
            ...
            <h1>
                Características técnicas Toyota Camry 1.0 54 kW
            </h1>
            <h2>
                Motor Combustión
            </h2>
            <p>Posición del motor: Delantero</p>
            <p>Tipo de combustible:Gasolina</p>
            <p>Cilindrada (cc): 1200 </p>
            <p>Número de cilindros: 4</p>
            <p>Válvulas por cilindro: 16</p>
            <p>Alimentación: Inyección .</p>
            <p>Distribución: 16 valvulas por cilindro.Dos árboles de levas en la culata.</p>
            <p>Sistema Stop&Start: Si</p>
            <p>Par máximo: (Nm / rpm) 221   </p>
            <p>Potencia máxima: Cv(kW) / rpm:178(52) / 5200</p>
            <p></p>

            <h2>
                Transmisión
            </h2>
            <p>Tipo de Tracción: Delantera y trasera </p>
            <p>Caja de cambio: CVT de 6 relaciones </p>
            ...
            <p>Capacidad maletero (litros): 525 </p>
            <p>Depósito combustible (litros): 50</p>
            <p>Número de asientos: 4 </p>

            <h2>
                Renndimiento
            </h2>
            <p>Consumo urbano (l/100 km): 6.0</p>
            <p>Consumo extraurbano (l/100 km): 3.7</p>
            <p>Consumo medio (l/100 km):4.1</p>
            <p>Emisiones de CO2 (gr/km): 107</p>
        ...
        <div class="container-aside">
            ...
            <aside>
                ...
                <a href="Mercedes-Benz_Clase_G.asp"><button>Rentar !Aqui¡</button></a>
            </aside>
